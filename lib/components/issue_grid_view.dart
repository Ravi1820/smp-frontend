...
class IssiesGridViewCard extends StatefulWidget {
  ...
  @override
  State<IssiesGridViewCard> createState() => _IssiesGridViewCardState();
}

class _IssiesGridViewCardState extends State<IssiesGridViewCard> {
