...
class ResidentGlobalSearchModel {
  UserInfo? userInfo;
  FlatInfo? flatInfo;

  ResidentGlobalSearchModel({this.userInfo, this.flatInfo});

  ResidentGlobalSearchModel.fromJson(Map<String, dynamic> json) {
