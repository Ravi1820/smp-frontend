...
class CheckOutVisitorsList extends StatefulWidget {
  CheckOutVisitorsList({super.key});

  @override
  State<CheckOutVisitorsList> createState() {
    return _CheckOutVisitorsList();
  }
}

class _CheckOutVisitorsList extends State<CheckOutVisitorsList>
        ...
        setState(() {
          ...
          if (_isNetworkConnected) {
            ...
            String visitorsListURL =
                '${Constant.allCheckOutVisitorsURL}?apartmentId=$id';
    ...
    try {
      setState(() {
        ...
        if (responseType == 'ownersList') {
          ...
          CheckoutVisitorListModel visitorsList =
              CheckoutVisitorListModel.fromJson(jsonResponse);
  ...
  Widget build(BuildContext context) {
    ...
    if (originalUsers.isNotEmpty) {
      content = Padding(
        ...
        child: CheckOutVisitorsListViewCard(
