...
class ResidentInprogressIssueScreen extends StatefulWidget {
  const ResidentInprogressIssueScreen({Key? key}) : super(key: key);

  @override
  State<ResidentInprogressIssueScreen> createState() =>
      _ResidentInprogressIssueScreenState();
}

class _ResidentInprogressIssueScreenState
    extends State<ResidentInprogressIssueScreen>
      ...
      setState(() {
        ...
        if (responseType == "issue") {
          ...
          if (responceModel.status == "error") {
            errorDialog(
                context, responceModel.message!, const ViewListScreen());
            _isLoading = false;
          } else {
            successDialog(
                context, responceModel.message!, const ViewListScreen());
