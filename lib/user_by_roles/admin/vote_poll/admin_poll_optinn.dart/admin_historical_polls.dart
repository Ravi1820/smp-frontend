...
class AdminHistoricalVoteOptionScreen extends StatefulWidget {
  const AdminHistoricalVoteOptionScreen({Key? key}) : super(key: key);

  @override
  State<AdminHistoricalVoteOptionScreen> createState() =>
      _AdminHistoricalVoteOptionScreenState();
}

class _AdminHistoricalVoteOptionScreenState
    extends State<AdminHistoricalVoteOptionScreen>
      ...
      body: AbsorbPointer(
        ...
        child: Stack(
          children: <Widget>[
            ...
            if (_isLoading)
              Positioned(
                  top: FontSizeUtil.CONTAINER_SIZE_130,
